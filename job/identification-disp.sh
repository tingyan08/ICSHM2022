...
python3 train_displacement_identification.py --arch regression --trainer CNN --load_model TripletAE --transfer True --max_epoch 500 --description Transfer_TripletAE