...
class FeatureExtractionDataset(Dataset):
    def __init__(self, path, source, mode="train", triplet=False, Damage=False) -> None:
        self.source = source
    ...
    def __getitem__(self, idx) -> torch.tensor:
        ...
        if self.source == "Displacement":
            if self.mode == "train":
                ...
                positive_state = self.train_id[positive_item]
                ...
                negative_state = self.train_id[negative_item]
                ...
                return (anchor_signal, None, None), \
                    (anchor_state, None, None), anchor_label
